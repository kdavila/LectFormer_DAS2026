...
from LectureMath.annotation.data.unique_cc_group import UniqueCCGroup
from LectureMath.preprocessing.content.aligner import Aligner

from LectureMath.util.visualizer import Visualizer
...
class Evaluator:
    ...
    def compute_pixel_binary_metrics(gt_frames, summary_frames):
        ...
        for idx, gt_frame in enumerate(gt_frames):
            ...
            only_board[gt_frame.background_mask] = 0.0
