...
class Labeler:
    ...
    lecturemath_lib = ctypes.CDLL(os.path.abspath('../lecturemath_lib.so'))
    ...
    def extractSpatioTemporalContent(content, ages, filter_small=True, is_labeled=False):
        ...
        Labeler.lecturemath_lib.CC_AgeBoundaries.argtypes = arg_types
        Labeler.lecturemath_lib.CC_AgeBoundaries.restype = ctypes.c_int32
        Labeler.lecturemath_lib.CC_AgeBoundaries(labels_p, ages_p, width, height, count_labels,
